            ...
            <div class="burger-table-row" v-for="burger in burgers" :key="burger.id">
                ...
                <div>
                    <select name="status" class="status" @change="updatedBurger($event, burger.id)">
                        ...
                        <option v-for="estado in status" :key="estado.id" :value="estado.tipo" 
                        :selected="burger.status == estado.tipo">{{ estado.tipo }}</option>
                    </select>
...
export default {
    ...
    methods: {
        ...
        async updatedBurger(event, id) {
            ...
            //Reaproveitamento do componente "coringa" message.vue
            //colocar uma msg de sistema
            this.msg = `O Pedido Nº ${res.id} está/foi ${res.status}!`;
